...
class DniProcesos(models.Model):
    ...
    id_operario = models.CharField(db_column='IdOperario', max_length=60, blank=True, null=True)  # Field name made lowercase.
    id_seccion = models.CharField(db_column='IdSeccion', max_length=30, blank=True, null=True)  # Field name made lowercase.
...
class Procesos(models.Model):
    id = models.AutoField(db_column='Id', primary_key=True)  # Field name made lowercase.
    id_ordenproduccion = models.CharField(db_column='IdOrdenProduccion', max_length=100)  # Field name made lowercase.
    id_operario = models.CharField(db_column='IdOperario', max_length=100)  # Field name made lowercase.
    id_seccion = models.CharField(db_column='IdSeccion', max_length=100)  # Field name made lowercase.
    fecha_hora = models.CharField(db_column='FechaHora', max_length=50, blank=True, null=True)  # Field name made lowercase.
